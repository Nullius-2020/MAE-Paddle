...
_C.MAE = CN()
_C.MAE.WINDOW_SIZE=(14,14) 
_C.MAE.MASK_RADIO=0.75
...
_C.MODEL.TRANS.ENCODER_EMBED_DIM = 768
_C.MODEL.TRANS.ENCODER_DEPTH= 12
_C.MODEL.TRANS.ENCODER_NUM_HEADS=12
_C.MODEL.TRANS.ENCODER_NUM_CLASSES=0
_C.MODEL.TRANS.DECODER_NUM_CLASSES=768
_C.MODEL.TRANS.DECODER_EMBED_DIM=384
_C.MODEL.TRANS.DECODER_DEPTH=4
_C.MODEL.TRANS.DECODER_NUM_HEADS=6
